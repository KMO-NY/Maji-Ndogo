...
-- Look for persons who have to queue for abnormal times 
...
FROM
    well_pollution
LIMIT 3; 
-- Find erronusly inputed data 
-- (recorded result as clean even though the biological > 0.01)
SELECT 
    *
FROM
    well_pollution
...
-- Find erronusly inputed data 
-- (recorded description as clean% even though the biological > 0.01)
SELECT 
    *
FROM
    well_pollution
